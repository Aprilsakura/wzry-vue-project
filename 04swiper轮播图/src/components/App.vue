    ...
    <div class="wrap">
        ...
        <div class="content">
            <div class="home_top">
                ...
                <div class="download">
                    <a href="http://pvp.qq.com/m/m201606/play.shtml"></a>
                </div>
            </div>
...
.home_top {
    margin: 0 auto;
    background: url(../img/hd.jpg) no-repeat 50% 0;
    left: 0;
    top: 0;
    height: 45px;
    width: 100%;
...
.home_bottom {
    background: url(../img/navnew11.png) no-repeat 50% 0;
    left: 0;
    top: auto;
    height: 0.87rem;
    width: 100%;
...
.currentL {
    background: url(../img/navnew2.png) no-repeat 50% 0;
